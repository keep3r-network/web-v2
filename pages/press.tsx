				...
				<div className={'mb-8'}>
					...
					<p>
						...
						<a
							download
							className={'underline'}
							href={'/presskit/PressKit.pdf'}>{'PDF'}
						</a>
					</p>
				</div>
					...
					<div className={'mb-10 flex flex-row space-x-8'}>
						<div className={'flex flex-col space-y-4'}>
							...
							<p>
								...
								<a
									download
									href={'/presskit/the_keep3r_black.svg'}
									className={'underline'}>{'SVG'}
								</a>
								{' '}
								<a
									download
									href={'/presskit/the_keep3r_black.png'}
									className={'underline'}>{'PNG'}
								</a>
							</p>
						</div>
						...
						<div className={'flex flex-col space-y-4'}>
							...
							<p>
								...
								<a
									download
									href={'/presskit/the_keep3r_network_black.svg'}
									className={'underline'}>{'SVG'}
								</a>
								{' '}
								<a
									download
									href={'/presskit/the_keep3r_network_black.png'}
									className={'underline'}>{'PNG'}
								</a>
							</p>
						</div>
						...
						<div className={'flex flex-col space-y-4'}>
							...
							<p>
								...
								<a
									download
									href={'/presskit/keep3r_mark_black.svg'}
									className={'underline'}>{'SVG'}
								</a>
								{' '}
								<a
									download
									href={'/presskit/keep3r_mark_black.png'}
									className={'underline'}>{'PNG'}
								</a>
							</p>
						</div>
					...
					<div className={'flex flex-row space-x-8'}>
						<div className={'flex flex-col space-y-4'}>
							...
							<p>
								...
								<a
									download
									href={'/presskit/the_keep3r_white.svg'}
									className={'underline'}>{'SVG'}
								</a>
								{' '}
								<a
									download
									href={'/presskit/the_keep3r_white.png'}
									className={'underline'}>{'PNG'}
								</a>
							</p>
						</div>
						...
						<div className={'flex flex-col space-y-4'}>
							...
							<p>
								...
								<a
									download
									href={'/presskit/the_keep3r_network_white.svg'}
									className={'underline'}>{'SVG'}
								</a>
								{' '}
								<a
									download
									href={'/presskit/the_keep3r_network_white.png'}
									className={'underline'}>{'PNG'}
								</a>
							</p>
						</div>
						...
						<div className={'flex flex-col space-y-4'}>
							...
							<p>
								...
								<a
									download
									href={'/presskit/keep3r_mark_white.svg'}
									className={'underline'}>{'SVG'}
								</a>
								{' '}
								<a
									download
									href={'/presskit/keep3r_mark_white.png'}
									className={'underline'}>{'PNG'}
								</a>
							</p>
						</div>
